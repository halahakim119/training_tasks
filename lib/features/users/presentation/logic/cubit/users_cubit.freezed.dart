...
mixin _$UsersState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<UsersEntity> users) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<UsersEntity> users)? loaded,
...
class _$_Loaded implements _Loaded {
  const _$_Loaded(final List<UsersEntity> users) : _users = users;

  final List<UsersEntity> _users;
  @override
...
abstract class _Loaded implements UsersState {
  const factory _Loaded(final List<UsersEntity> users) = _$_Loaded;
